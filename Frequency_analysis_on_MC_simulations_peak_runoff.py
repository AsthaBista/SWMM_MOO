...
# List all CSV files in the folder and sort them (optional, if filenames are unordered)
...
for idx, file in enumerate(csv_files, start=1):
    ...
    result_entry = {"sim_number": f"sim{idx}"}  # Renaming filenames as sim1, sim2, ...
...
# Save results to CSV
output_file = r'C:\Users\ABI\My_Files\MonteCarlo\peakrunoff_for_return_periods.csv'
